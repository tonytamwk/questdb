...
public class MinNanoTimestampVectorAggregateFunction extends NanoTimestampFunction implements VectorAggregateFunction {
    ...
    public MinNanoTimestampVectorAggregateFunction(int position, int keyKind, int columnIndex, int workerCount) {
        super(position);

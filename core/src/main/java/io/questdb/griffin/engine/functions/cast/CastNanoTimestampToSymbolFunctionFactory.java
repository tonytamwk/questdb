...
public class CastNanoTimestampToSymbolFunctionFactory implements FunctionFactory {
    @Override
    ...
    public Function newInstance(ObjList<Function> args, int position, CairoConfiguration configuration) {
        ...
        if (arg.isConstant()) {
            ...
            sink.put(arg.getNanoTimestamp(null));
    ...
    private static class Func extends SymbolFunction implements UnaryFunction {
        ...
        public CharSequence getSymbol(Record rec) {
            final long value = arg.getNanoTimestamp(rec);

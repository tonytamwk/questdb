...
public class MaxNanoTimestampGroupByFunction extends NanoTimestampFunction implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private int valueIndex;

    public MaxNanoTimestampGroupByFunction(int position, @NotNull Function arg) {
        super(position);
        this.arg = arg;
    }
    ...
    public void computeFirst(MapValue mapValue, Record record) {
        mapValue.putNanoTimestamp(valueIndex, arg.getNanoTimestamp(record));
    }

    @Override
    public void computeNext(MapValue mapValue, Record record) {
        long max = mapValue.getNanoTimestamp(valueIndex);

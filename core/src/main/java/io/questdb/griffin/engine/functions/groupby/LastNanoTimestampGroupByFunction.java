...
public class LastNanoTimestampGroupByFunction extends NanoTimestampFunction implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private int valueIndex;

    public LastNanoTimestampGroupByFunction(int position, @NotNull Function arg) {
        super(position);
        this.arg = arg;
    }

...
public class NanoTimestampFormatFactory {
    private final static ThreadLocal<DateFormatCompiler> tlCompiler = ThreadLocal.withInitial(DateFormatCompiler::new);
    private static final Function<CharSequence, NanoTimestampFormat> mapper = NanoTimestampFormatFactory::map;
    private final ConcurrentHashMap<NanoTimestampFormat> cache = new ConcurrentHashMap<>();

    private static NanoTimestampFormat map(CharSequence value) {
     ...
     */
    public NanoTimestampFormat get(CharSequence pattern) {

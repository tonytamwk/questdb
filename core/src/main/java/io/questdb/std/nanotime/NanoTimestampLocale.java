...
public class NanoTimestampLocale {
    ...
    NanoTimestampLocale(DateFormatSymbols symbols, TimeZoneRuleFactory timeZoneRuleFactory, @Transient CharSequenceHashSet cache) {

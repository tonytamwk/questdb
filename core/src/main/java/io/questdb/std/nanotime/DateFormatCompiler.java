...
public class DateFormatCompiler {
    ...
    static final int OP_NANOS_ONE_DIGIT = 59;
    static final int OP_NANOS_THREE_DIGITS = 69;
    static final int OP_NANOS_GREEDY = 159;
    ...
    private static final int FA_MILLIS_NANOS = 12;
    ...
    public NanoTimestampFormat compile(CharSequence pattern) {
        return compile(pattern, false);
    }

    public NanoTimestampFormat compile(CharSequence pattern, boolean generic) {
        return compile(pattern, 0, pattern.length(), generic);
    }

    public NanoTimestampFormat compile(CharSequence pattern, int lo, int hi, boolean generic) {
        ...
        makeLastOpGreedy(ops);
        return generic ? new GenericNanoTimestampFormat(ops, delimiters) : compile(ops, delimiters);
    }
        ...
        for (int i = 0, n = ops.size(); i < n; i++) {
            ...
            switch (op) {
                ...
                case DateFormatCompiler.OP_NANOS_GREEDY:
                    asm.aload(FA_LOCAL_SINK);
                    asm.iload(fmtAttributeIndex[FA_MILLIS_NANOS]);
    ...
    private void assembleFormatMethodStack(
        ...
        if (invokeConvertMillis(formatAttributes, FA_MILLIS_NANOS, getNanosOfSecondIndex, index)) {
            fmtAttributeIndex[FA_MILLIS_NANOS] = index++;
        }
    ...
    private void assembleParseMethod(IntList ops, ObjList<String> delimiters, int thisClassIndex, int stackMapTableIndex, int dateLocaleClassIndex, int charSequenceClassIndex, int minLongIndex, int minMillisIndex, int matchWeekdayIndex, int matchMonthIndex, int matchZoneIndex, int matchAMPMIndex, int matchEraIndex, int parseIntSafelyIndex, int decodeLenIndex, int decodeIntIndex, int assertRemainingIndex, int assertNoTailIndex, int parseIntIndex, int assertStringIndex, int assertCharIndex, int computeMillisIndex, int adjustYearIndex, int parseYearGreedyIndex, int parseOffsetIndex, int parseNameIndex, int parseSigIndex, IntList delimIndices, int charAtIndex) {
        ...
        asm.iconst(NanoTimestampFormatUtils.HOUR_24);
     ...
     */
    private NanoTimestampFormat compile(IntList ops, ObjList<String> delimiters) {
        asm.init(NanoTimestampFormat.class);
        asm.setupPool();
        ...
        int superclassIndex = asm.poolClass(AbstractNanoTimestampFormat.class);
        int dateLocaleClassIndex = asm.poolClass(NanoTimestampLocale.class);
        int charSequenceClassIndex = asm.poolClass(CharSequence.class);
        int minLongIndex = asm.poolLongConst(Long.MIN_VALUE);
        int minMillisIndex = asm.poolLongConst(NanoTimestamps.MINUTE_NANOS);

        int superIndex = asm.poolMethod(superclassIndex, "<init>", "()V");
        int matchWeekdayIndex = asm.poolMethod(NanoTimestampLocale.class, "matchWeekday", "(Ljava/lang/CharSequence;II)J");
        int matchMonthIndex = asm.poolMethod(NanoTimestampLocale.class, "matchMonth", "(Ljava/lang/CharSequence;II)J");
        int matchZoneIndex = asm.poolMethod(NanoTimestampLocale.class, "matchZone", "(Ljava/lang/CharSequence;II)J");
        int matchAMPMIndex = asm.poolMethod(NanoTimestampLocale.class, "matchAMPM", "(Ljava/lang/CharSequence;II)J");
        int matchEraIndex = asm.poolMethod(NanoTimestampLocale.class, "matchEra", "(Ljava/lang/CharSequence;II)J");
        int getWeekdayIndex = asm.poolMethod(NanoTimestampLocale.class, "getWeekday", "(I)Ljava/lang/String;");
        int getShortWeekdayIndex = asm.poolMethod(NanoTimestampLocale.class, "getShortWeekday", "(I)Ljava/lang/String;");
        int getMonthIndex = asm.poolMethod(NanoTimestampLocale.class, "getMonth", "(I)Ljava/lang/String;");
        int getShortMonthIndex = asm.poolMethod(NanoTimestampLocale.class, "getShortMonth", "(I)Ljava/lang/String;");
        ...
        int assertRemainingIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "assertRemaining", "(II)V");
        int assertNoTailIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "assertNoTail", "(II)V");
        int assertStringIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "assertString", "(Ljava/lang/CharSequence;ILjava/lang/CharSequence;II)I");
        int assertCharIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "assertChar", "(CLjava/lang/CharSequence;II)V");
        int computeMillisIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "compute", "(Lio/questdb/std/microtime/TimestampLocale;IIIIIIIIIIJI)J");
        int adjustYearIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "adjustYear", "(I)I");
        int parseYearGreedyIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "parseYearGreedy", "(Ljava/lang/CharSequence;II)J");
        int appendEraIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "appendEra", "(Lio/questdb/std/str/CharSink;ILio/questdb/std/microtime/TimestampLocale;)V");
        int appendAmPmIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "appendAmPm", "(Lio/questdb/std/str/CharSink;ILio/questdb/std/microtime/TimestampLocale;)V");
        int appendHour12Index = asm.poolMethod(NanoTimestampFormatUtils.class, "appendHour12", "(Lio/questdb/std/str/CharSink;I)V");
        int appendHour12PaddedIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "appendHour12Padded", "(Lio/questdb/std/str/CharSink;I)V");
        int appendHour121Index = asm.poolMethod(NanoTimestampFormatUtils.class, "appendHour121", "(Lio/questdb/std/str/CharSink;I)V");
        int appendHour121PaddedIndex = asm.poolMethod(NanoTimestampFormatUtils.class, "appendHour121Padded", "(Lio/questdb/std/str/CharSink;I)V");
        int append000Index = asm.poolMethod(NanoTimestampFormatUtils.class, "append000", "(Lio/questdb/std/str/CharSink;I)V");
        int append00Index = asm.poolMethod(NanoTimestampFormatUtils.class, "append00", "(Lio/questdb/std/str/CharSink;I)V");
        int append0Index = asm.poolMethod(NanoTimestampFormatUtils.class, "append0", "(Lio/questdb/std/str/CharSink;I)V");

        int parseOffsetIndex = asm.poolMethod(NanoTimestamps.class, "parseOffset", "(Ljava/lang/CharSequence;II)J");
        int getYearIndex = asm.poolMethod(NanoTimestamps.class, "getYear", "(J)I");
        int isLeapYearIndex = asm.poolMethod(NanoTimestamps.class, "isLeapYear", "(I)Z");
        int getMonthOfYearIndex = asm.poolMethod(NanoTimestamps.class, "getMonthOfYear", "(JIZ)I");
        int getDayOfMonthIndex = asm.poolMethod(NanoTimestamps.class, "getDayOfMonth", "(JIIZ)I");
        int getHourOfDayIndex = asm.poolMethod(NanoTimestamps.class, "getHourOfDay", "(J)I");
        int getMinuteOfHourIndex = asm.poolMethod(NanoTimestamps.class, "getMinuteOfHour", "(J)I");
        int getSecondOfMinuteIndex = asm.poolMethod(NanoTimestamps.class, "getSecondOfMinute", "(J)I");
        int getMillisOfSecondIndex = asm.poolMethod(NanoTimestamps.class, "getMillisOfSecond", "(J)I");
        int getMicrosOfSecondIndex = asm.poolMethod(NanoTimestamps.class, "getMicrosOfSecond", "(J)I");
        int getNanosOfSecondIndex = asm.poolMethod(NanoTimestamps.class, "getNanosOfSecond", "(J)I");
        int getDayOfWeekIndex = asm.poolMethod(NanoTimestamps.class, "getDayOfWeekSundayFirst", "(J)I");
    ...
    private void setHourType(int stackState) {
        ...
        asm.iconst(NanoTimestampFormatUtils.HOUR_AM);
        asm.istore(LOCAL_HOUR_TYPE);
        int p = asm.position();
        frameOffsets.add(Numbers.encodeLowHighInts(stackState, p));
        asm.setJmp(branch, p);
